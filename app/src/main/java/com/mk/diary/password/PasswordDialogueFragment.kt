...
import my.dialy.dairy.journal.dairywithlock.databinding.FragmentPasswordDialogueBinding
import java.util.concurrent.Executor


class PasswordDialogueFragment : DialogFragment() {
    lateinit var binding: FragmentPasswordDialogueBinding
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        dialog.setContentView(R.layout.fragment_password_dialogue)
        // Adjust dialog window attributes to make it full-screen
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentPasswordDialogueBinding.inflate(layoutInflater)
