...
import my.dialy.dairy.journal.dairywithlock.databinding.FragmentClassicBinding
...
class ClassicFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding= FragmentClassicBinding.inflate(layoutInflater,container,false)
        viewModel.getClassic()
        recyclerView()
        viewModel()
        return binding.root
    }
    ...
    private fun viewModel(){
        viewModel.classicLiveData.observe(viewLifecycleOwner){result->
            when(result){
