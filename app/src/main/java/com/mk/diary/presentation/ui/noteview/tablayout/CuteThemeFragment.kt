...
import my.dialy.dairy.journal.dairywithlock.databinding.FragmentCuteThemeBinding

@AndroidEntryPoint
class CuteThemeFragment : Fragment() {
    ...
    lateinit var binding: FragmentCuteThemeBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentCuteThemeBinding.inflate(layoutInflater,container,false)
        viewModel.getCute()
        recyclerView()
        viewModel()
        return binding.root
    ...
    private fun viewModel(){
        viewModel.cuteLiveData.observe(viewLifecycleOwner){result->
            when(result){
