...
import my.dialy.dairy.journal.dairywithlock.databinding.FragmentSimpleThemBinding

@AndroidEntryPoint
class SimpleThemFragment : Fragment() {
    ...
    lateinit var binding: FragmentSimpleThemBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentSimpleThemBinding.inflate(layoutInflater,container,false)
        viewModel.getSimple()
        recyclerView()
        viewModel()
        return binding.root
    ...
    private fun viewModel(){
        viewModel.simpleLiveData.observe(viewLifecycleOwner){result->
            when(result){
